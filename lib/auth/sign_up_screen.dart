...
import 'package:b_store/auth/sign_in_screen.dart';
import 'package:b_store/auth/verify-account_screen.dart';
...
class _SignUpScreenState extends State<SignUpScreen> with Helpers{
  ...
  Future createAccount()async{
    int? code =  await AuthApiController().Resgister(context, mobile: _mobileController.text, password:_passwordController.text, name:_nameController.text, STORE_API_KEY: '07f81110-919e-42b0-a073-82623d4bab1e', gender: isMale ? 'M' : 'F',city_id:city!.id);
    if(code!= null){
